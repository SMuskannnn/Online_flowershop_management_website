        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="user_registration.php"> <b>Sign up</b> </a>
              </li>
              <?php
            ...
            <!-- <form class="d-flex" role="search">
              <input class="form-control me-2 custom-padding" type="search" placeholder="Search" aria-label="Search" name="search_data">
              <input class="btn btn-outline-success" placeholder="Search" type="submit" value="Search" name="search_data_product">
            </form> -->
          </div>
        </div>
      </nav> 
<!-- Welcome division -->
      ...
      <img src="./images/welcome.jpg" alt="" class="welcome-img"></img>
        <div class="overlay-text">
          <p><b>Everbloom welcomes you</b></p>
        </div>
      </div>
    </div>
...
<!-- Category section -->
    <div class="bg-light">
      <br>
      <h3 class="text-center"> <b>SHOP BY CATEGORY </b></h3>
      <br>
    </div>
    <!--IMAGE BUTTONS-->
    <div class="gallery">
      <!-- <div class="row"> -->
        <div class="element">
        <a href="roses.php">
          <img src="./images/roses.jpg" alt="" class="category"></img>
        ...
        <div class="element">
        <a href="lilies.php">
          <img src="./images/lilies.jpg" alt="" class="category"></img>
          <div class="category-name">
            <p>Lilies</p>
        </div>
        </a>
        ...
        <div class="element">
        <a href="tulips.php">
          <img src="./images/tulips.jpg" alt="" class="category"></img>
          <div class="category-name">
            <p>Tulips</p>
        </div>
        </a>
      ...
      <!-- <div class="row"> -->
        <div class="element">
        <a href="sunflowers.php">
          <img src="./images/sunflowers.jpg" alt="" class="category"></img>
          <div class="category-name">
            <p>Sunflowers</p>
        </div>
        </a>
        ...
        <div class="element">
        <a href="chrysanthamums.php">
          <img src="./images/chrysanthamums.jpg" alt="" class="category"></img>
          <div class="category-name">
            <p>Chrysanthamums</p>
        </div>
        </a>  
        ...
        <div class="element">
        <a href="mix.php">
          <img src="./images/mix.jpg" alt="" class="category"></img>
          <div class="category-name">
            <p>Mixes</p>
        </div>
        </a>  
...
<div class="feedback-form">
  <p><b>We welcome constructive feedback</b></p>
  <textarea name="feedback" placeholder="Please give us some feedback here" rows="4"></textarea>
