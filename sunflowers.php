...
<head>
    ...
    <title> Sunflowers section </title>
    <!--bootstrap CSS link -->
...
<!-- Welcome division -->
      ...
      <img src="./images/sunflowers.jpg" alt="" class="welcome-img"></img>
        <div class="overlay-text">
          <p><b>Your everyday sunflowers</b></p>
        </div>
      </div>
    </div>
...
<!-- Category section -->
    <div class="bg-light">
      <br>
      <h3 class="text-center"> <b>SUNFLOWERS SECTION </b></h3>
      <br>
    </div>
