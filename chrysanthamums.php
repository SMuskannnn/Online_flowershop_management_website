...
<head>
    ...
    <title> Chrysanthamums section </title>
    <!--bootstrap CSS link -->
...
<!-- Welcome division -->
      ...
      <img src="./images/chrysanthamums.jpg" alt="" class="welcome-img"></img>
        <div class="overlay-text">
          <p><b>Your everyday chrysanthamums</b></p>
        </div>
      </div>
    </div>
...
<!-- Category section -->
    <div class="bg-light">
      <br>
      <h3 class="text-center"> <b>CHRYSANTHAMUMS SECTION </b></h3>
      <br>
    </div>

<!--VARIOUS CHRYSANTHAMUMS-->
<div class="container">
    <div class="row">
       <?php
      getproducts(5);
